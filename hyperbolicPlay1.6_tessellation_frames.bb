...
;;	rad# = dis*(Sqr(1+dis^2)*(1-Cos(phi))*Cos(theta/2) + Sin(phi)*Sin(theta/2))
	...
	;draw(R)
	;SaveBuffer(FrontBuffer(), "C:\Users\El'endia Starman\Desktop\Lee's\Programming\BASIC Stuff\Blitz Basic 2D\Hyperbolic Geometry\Hyperbolic tessellation frames\hyperbolicTessellation_frame"+fnum+".png")
	;WaitKey
