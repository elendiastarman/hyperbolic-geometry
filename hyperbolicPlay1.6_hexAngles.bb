...
Function init(loc$)
	...
	;first hexagon
	p = createPoint(r,0, 0,0,255)
	polygon_oriented(r,0, 0,0, r,k)
	p2 = Last point
	...
	;second hexagon
	p = createPoint(r*Cos(-theta),r*Sin(-theta), 0,0,255)
	polygon_oriented(r*Cos(-theta),r*Sin(-theta), 0,0, r,k)
	p2 = Last point
