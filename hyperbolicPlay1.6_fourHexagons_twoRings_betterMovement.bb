...
;	startY = 10
	...
	For k = 0 To 3
		newX# = offsetStep(0,0, 2*dis,k*90, 1)
		newY# = offsetStep(0,0, 2*dis,k*90, 2)
		
		For k2 = 0 To 3
			tempX2# = offsetStep(0,0, dis,k2*90, 1)
			tempY2# = offsetStep(0,0, dis,k2*90, 2)
			...
			polygon(newX2,newY2, dis, 6, k2*30 - Sin((k+k2)*90)*15 + Abs(Sin(k*90))*Sin((k2-1)*90)*30); + k*90)
		Next
	Next
